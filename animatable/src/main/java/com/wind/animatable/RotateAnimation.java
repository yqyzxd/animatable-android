...
import com.wind.animatable.Animatable.AbsAnimation;

/**
 * created by wind on 6/11/21:8:18 PM
 */
public class RotateAnimation extends AbsAnimation {


    public RotateAnimation(Animatable.AnimationBuilder builder) {
        super(builder);
    }
    ...
    public Animator buildAnimator(Animatable.AnimationBuilder builder) {
        return  ObjectAnimator.ofFloat(builder.getTarget(),"rotation",builder.getValues());
    }
